 ...
 */
public class CopyOfDefaultRosterItemProvider implements RosterItemProvider {

	private static final Logger Log = LoggerFactory.getLogger(CopyOfDefaultRosterItemProvider.class);
    ...
    private static final String COUNT_ROSTER_ITEMS =
     ...
     private static final String LOAD_ROSTER =
             "SELECT jid, rosterID, sub, ask, recv, nick,version FROM ofRoster WHERE username=?";
            ...
            throws UserAlreadyExistsException
    {
        ...
        try {
            ...
            pstmt.setLong(8, item.getCurrVersion());
            pstmt.executeUpdate();
