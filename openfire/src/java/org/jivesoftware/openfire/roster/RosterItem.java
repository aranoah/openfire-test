...
public class RosterItem implements Cacheable, Externalizable {
    ...
    public int getCachedSize() throws CannotCalculateSizeException {
        ...
        size += CacheSizes.sizeOfLong(); //version
        return size;
    }
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        ExternalizableUtil.getInstance().writeLong(out, currVersion);
    }
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        currVersion = ExternalizableUtil.getInstance().readLong(in);
    }
}
